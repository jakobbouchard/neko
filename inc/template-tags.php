...
if ( ! function_exists( 'neko_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function neko_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( 'by %s', 'post author', 'neko' ),
...
if ( ! function_exists( 'neko_entry_footer' ) ) :
	...
	function neko_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			$categories_list = get_the_category_list( esc_html__( ', ', 'neko' ) );
			if ( $categories_list ) {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'neko' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'neko' ),
					array(
						'span' => array(
							'class' => array(),
						),
